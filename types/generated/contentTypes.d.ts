...
export interface ApiAgencyAddressAgencyAddress
  extends Struct.CollectionTypeSchema {
...
export interface ApiAgencyContactAgencyContact
  extends Struct.CollectionTypeSchema {
  collectionName: 'agency_contacts';
  info: {
    displayName: 'Agency Contact';
    pluralName: 'agency-contacts';
    singularName: 'agency-contact';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::agency-contact.agency-contact'
    > &
      Schema.Attribute.Private;
...
export interface ApiAgencyAgency extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    agency_addresses: Schema.Attribute.Relation<
      'oneToMany',
      'api::agency-address.agency-address'
    >;
    agency_contacts: Schema.Attribute.Relation<
      'oneToMany',
      'api::agency-contact.agency-contact'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::agency-contact.agency-contact': ApiAgencyContactAgencyContact;
